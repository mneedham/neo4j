...
test_expect_success "should invoke restore main class and pass through all arguments" "
  neo4j-home/bin/neo4j-admin restore --from=backup.db --database=foo.db --force  &&
