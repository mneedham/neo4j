 ...
 */
public class HAClusterMembers implements ClusterMembers
{
    ...
    public HAClusterMembers( Cluster cluster, Heartbeat heartbeat, ClusterMemberEvents events, InstanceId me )
    {
        this.me = me;
