...
/**
 * This is the main factory for creating database instances. It delegates creation to three different modules ({@link org.neo4j.kernel.impl.factory.PlatformModule}, {@link org.neo4j.kernel.impl.factory.EditionModule}, and {@link org.neo4j.kernel.impl.factory.DataSourceModule}),
 * which create all the specific services needed to run a graph database.
 *
 * It is abstract in order for subclasses to specify their own {@link org.neo4j.kernel.impl.factory.EditionModule} implementations. Subclasses also have to set the edition name
 * in overriden version of {@link #newFacade(java.util.Map, org.neo4j.kernel.impl.factory.GraphDatabaseFacadeFactory.Dependencies, GraphDatabaseFacade)}, which is used for logging and similar.
 *
 * To create test versions of databases, override an edition factory (e.g. {@link org.neo4j.kernel.impl.factory.CommunityFacadeFactory}), and replace modules
...
public abstract class GraphDatabaseFacadeFactory
{
    ...
    /**
     * Instantiate a graph database given configuration, dependencies, and a custom implementation of {@link org.neo4j.kernel.impl.factory.GraphDatabaseFacade}.
     *
     * @param params
     * @param dependencies
                                          ...
                                          final GraphDatabaseFacade graphDatabaseFacade )
    {
        ...
        try
        {
            enableAvailabilityLogging( platform.availabilityGuard, platform.logging.getInternalLog( getClass() ).infoLogger() ); // Done after create to avoid a redundant
    ...
    /**
     * Create the edition module. Implement to provide the edition services specified by the public fields in {@link org.neo4j.kernel.impl.factory.EditionModule}.
