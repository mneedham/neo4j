...
{
    public AdvancedNeoServer( ConfigurationBuilder configurator, Database.Factory dbFactory, CommunityFacadeFactory.Dependencies dependencies, LogProvider logProvider)
    {
        super( configurator, dbFactory, dependencies, logProvider );
    }

	public AdvancedNeoServer( ConfigurationBuilder configurator, CommunityFacadeFactory.Dependencies dependencies, LogProvider logProvider)
    {
